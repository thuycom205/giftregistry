...
<link rel="stylesheet" href="https://app.mobileappseed.com/s_shopify_registry/static/src/select2.min.css">
<link rel="stylesheet" href="https://app.mobileappseed.com/s_shopify_registry/static/src/tooltipster.bundle.min.css">
<link rel="stylesheet" href="https://app.mobileappseed.com/s_shopify_registry/static/src/registry_frontend.css">

<script src="https://app.mobileappseed.com/s_shopify_registry/static/src/jquery-3.6.0.js" defer></script>
        
<script src="https://app.mobileappseed.com/s_shopify_registry/static/src/selectize.js" defer></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css">
<script src="https://app.mobileappseed.com/s_shopify_registry/static/src/flatpickr.js" defer></script>

<script src="https://app.mobileappseed.com/s_shopify_registry/static/src/select2.min.js" defer></script>
<script src="https://app.mobileappseed.com/s_shopify_registry/static/src/qrcode.min.js"></script>
<script src="https://app.mobileappseed.com/s_shopify_registry/static/src/tooltipster.bundle.min.js" defer></script>
...
<!--end of share -->
                 <div class="card-body-section share-section">
                     <div id="share_section">
                         <h3>
                             <strong>
                                 <img src="https://app.mobileappseed.com/s_shopify_registry/static/src/img/share.png" width="20px"
                         ...
                         <p style="width: 50%" id="link-text-share">  <input type="hidden" id="mas_r_sharelink_input_text" /> </span>
                             <img  class="vote-up-off" id="mas_r_sharelink_img" onclick="return mas_r_copy_sharelink(this)"
                                                                                    ...
                                                                                    src="https://app.mobileappseed.com/s_shopify_registry/static/src/img/copy.png"
                                                                                    style="float: right">
                         </p>
                     ...
                     <ul class="ul_share">
                         <li class="li_share">
                             <a target="_blank"  id="mas_facebook_share" class="facebook_share"  onclick="return fbs_click()">
                                 <img src="https://app.mobileappseed.com/s_shopify_registry/static/src/img/fb.png" />
                             </a>
                         </li>
                         <li class="li_share">
                             <a target="_blank" id="mas_tw_share" class="twitter_share" href="">
                                 <img src="https://app.mobileappseed.com/s_shopify_registry/static/src/img/tw.png" />
                             </a>
                         </li>
                         <li class="li_share" id="">
                             <button id="btn_qr" class="btn" onclick="return generate_qr_code(this)"> Generate QR</button>
                             <img title="Create beautiful QR code for gift registry and share it with your friends!"  class="tooltipster"  src="https://app.mobileappseed.com/s_shopify_registry/static/src/img/info.png"  />
                         </li>
                     </ul>
                ...
                <!--end of share -->
                <form style="padding: 50px" method="post"  onsubmit="return submit_form_registry(this)" action="https://app.mobileappseed.com/gift-registryx/save"
                      id="lc_gr_form_info" >
